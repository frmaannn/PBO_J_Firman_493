...
import java.util.Scanner; // Untuk mendapatkan tahun sekarang

public class Codelab1 {
    public static void main(String[] args) {
        // Langkah 2: Minta input nama
        try ( // Langkah 1: Buat Scanner untuk ambil input dari pengguna
            ...
            jenisKelaminTeks = switch (jenisKelamin) {
                case 'L', 'l' -> "Laki-laki";
                case 'P', 'p' -> "Perempuan";
